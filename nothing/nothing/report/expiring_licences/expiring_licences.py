...
def execute(filters=None):
    columns, data = [], []
    columns = [
            {"label": _("Licence"), "fieldname": "licence", "fieldtype": "Link", "options": "Licences", "width":"80"},
            {"label": _("Customer Nr."), "fieldname": "customer", "fieldtype": "Link", "options": "Customer", "width":"100"},
            {"label": _("Customer"), "fieldname": "customer_name", "fieldtype": "Data", "width":"200"},
            {"label": _("Customer Contact Person"), "fieldname": "cust_contact_person", "fieldtype": "Link", "options": "Contact", "width":"120"},
            {"label": _("Billing Invervall"), "fieldname": "billing_intervall", "fieldtype": "Select", "width":"100"},
            {"label": _("Responsible"), "fieldname": "responsible", "fieldtype": "Link", "options": "User", "width":"120"},
            {"label": _("Expiration Date"), "fieldname": "expiration_date", "fieldtype": "Date", "width":"150"}
            ]
...
def get_licences(responsible=None, customer=None, billing_intervall=None, from_date=None, to_date=None):
    ...
    sql_query = """SELECT 
                ...
                `tabLicences`.`customer_name` AS `customer_name`,
